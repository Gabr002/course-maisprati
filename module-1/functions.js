...
// Aplicação de ARROW FUNCTION (Função de Seta) - ES6+
...
// O QUE É "this" NA ARROW FUNCTION?
// Arrow function NÃO têm seu próprio "this".
// Elas herdam o "this" do escopo onde foram CRIADAS (escopo léxico).
// Isso resolve um problema clássico do JavaScript
...
const timer = {
  ...
  iniciarErrado: function () {
    setInterval(function () {
      // O que é setInterval:
      // É uma função que executa repetidamente uma outra função ou trecho de código, com um atraso fixo entre cada execução.
      // O primeiro argumento é a função a ser executada e o segundo é o intervalo em milissegundos.
